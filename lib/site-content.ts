...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  services_items: [
    { title: 'AI Capability Development',    desc: 'Corporate AI training programmes, executive workshops, workforce transformation, train-the-trainer, and university partnerships. Designed to take organisations from AI-curious to AI-capable.', features: ['Custom curriculum design','Hands-on AI workshops','Certificate programmes','Leadership AI immersions','Train-the-trainer','English & Khmer delivery'] },
