...
export interface ServiceItem   { title: string; desc: string; features: string[]; }
export interface ServiceTeaser { title: string; title_kh: string; desc: string; }
...
export interface SiteContent {
  ...
  home_services_heading:   string; home_services_heading_kh: string;
  home_services_sub:       string; home_services_sub_kh:     string;
  home_services_cta:       string; home_services_cta_kh:     string;
  ...
  home_subscribe_heading:       string; home_subscribe_heading_kh:     string;
  home_subscribe_sub:           string; home_subscribe_sub_kh:         string;
  home_subscribe_cta:           string; home_subscribe_cta_kh:         string;
  home_subscribe_placeholder:   string; home_subscribe_placeholder_kh: string;
...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  home_hero_stats: [
    ...
    { value: 'ASEAN', label: 'Conference Speaker' },
  ],
  home_hero_photo_name:  'HIN Sopheap',
  home_hero_photo_title: 'Co-Founder & Chairman, Cambodia AI Group',
  ...
  about_bio: [
    ...
    "I pivoted fully into AI because I saw a dangerous gap forming in Cambodia: global AI adoption accelerating while Cambodian leaders were left without the frameworks, skills, or local-context knowledge to act wisely.",
    'Cambodia AI Group — the consolidated home of DG Academy, NeuraSpace AI, and AngkorGate AI — is my answer to that gap.',
  ],
  about_credentials: [
...
export function mergeSiteContent(fetched: Partial<SiteContent> | null): SiteContent {
  ...
  return {
    ...DEFAULT_CONTENT,
    ...fetched,
    home_hero_stats:       fetched.home_hero_stats       ?? DEFAULT_CONTENT.home_hero_stats,
    home_services_items:   fetched.home_services_items   ?? DEFAULT_CONTENT.home_services_items,
    services_items:        fetched.services_items        ?? DEFAULT_CONTENT.services_items,
    services_testimonials: fetched.services_testimonials ?? DEFAULT_CONTENT.services_testimonials,
